...
class DoctorPhoneVerify extends StatefulWidget {
  const DoctorPhoneVerify({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _DoctorPhoneVerifyState createState() => _DoctorPhoneVerifyState();
}

class _DoctorPhoneVerifyState extends State<DoctorPhoneVerify> {
          ...
          child: Column(
            children: [
              const Align(
                ...
                child: Text(
                  "Lorem ipsum dolor sit amet 11, consectetur adi piscing elit. Quis sapien arcu",
                ),
              ),
              const SizedBox(
                height: 30,
